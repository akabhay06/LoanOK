       ...
       <div className="pb-5 py-10">
              <div className="px-4 sm:px-6 md:px-8 lg:px-16">
                ...
                <div className="bg-gradient-to-r from-[#7c746e] to-[#7c746e] rounded-2xl p-6 text-white shadow-2xl">
                  ...
                  Ghar Ho Safe, Toh Life Ho Great
                  </h1>
                </div>

                <div className="bg-[#9b958d] transform transition duration-300 hover:scale-105 hover:shadow-xl mt-8 max-w-[670px] py-3 mr-auto text-center border rounded-2xl text-3xl sm:text-6xl text-white font-bold ">
                HOME INSURANCE
                </div>
