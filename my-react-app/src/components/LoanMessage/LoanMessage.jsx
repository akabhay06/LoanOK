...
const LoanMessage = () => {
  return (
    <div>
      ...
      <div className="fixed z-50 bottom-0 left-0 w-full p-1 sm:p-4 bg-white border rounded-t-2xl space-x-5 flex justify-center items-center flex-col md:flex-row md:space-x-5">
      ...
      {/* Emoji image */}
      <div
        className="fixed z-50 bottom-0  w-[110px] h-[90px] sm:w-[130px] sm:h-[110px] ml-1 bg-transparent md:ml-80 md:w-[150px] md:h-[130px]"
        style={{
